...
rewards 
	[discard] true : DISCARD_COST; // cost for having to discard a request due to full queue
endrewards

module nonStopSimpleTransmissionProtocol
...
fdelay timeoutTime = 30.0; // time until Timeout of a transmission attempt
	...
	[discard] (requests=K) -> GEN_RATE: true; //nothing happens
