...
do
  ./prism -explicit -epsilon 1e-5 -maxiters 10000000 -power -absolute -const k=$k,timeout=$1,lambda=$lambda "$MODEL_PATH_FROM_PRISM/queue_withptf_gsmp.sm" -ss -exportss "$LOG_PATH_FROM_PRISM/t=$1/explicit/ph_10_${k}_1E-5" > "$LOG_PATH_FROM_PRISM/t=$1/explicit/ph_10_${k}_1E-5.log"
done
...
do
  ./prism -hybrid -epsilon 1e-5 -maxiters 10000000 -power -absolute -const k=$k,timeout=$1,lambda=$lambda "$MODEL_PATH_FROM_PRISM/queue_withptf_ctmc.sm" -ss -exportss "$LOG_PATH_FROM_PRISM/t=$1/hybrid/ph_10_${k}_1E-5" > "$LOG_PATH_FROM_PRISM/t=$1/hybrid/ph_10_${k}_1E-5.log"
done
cd -
