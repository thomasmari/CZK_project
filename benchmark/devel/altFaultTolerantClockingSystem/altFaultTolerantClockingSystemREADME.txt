...
Also, this model has quite a problem that I have not dealt with before.
It had a fixed delay event enabling two weighted immediate transitions.
This normally would not be a problem, but the immediate transitions are to transit M tokens.
I created this model as a workaround using quick exponential transitions as a way to deal with this.

MODIFIABLE PARAMETERS: M=4

DSPN EXPLANATION:
M=4 is the amount of modules.
...
When detection period begins through T10, exponential transitions t13, t14, t15 and t16
