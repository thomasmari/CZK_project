...
fdelay service1Time  = 1.5; // time it takes to finish the first part of the job
fdelay service2Time  = 0.5; // time it takes to finish the second part of the job
	...
	[firstStage] (stage=0) --service1Time-> (stage'=1);

	[secondStage] (stage=1) --service2Time-> (stage'=0);
