COMMENTARY:
Small modification of simpleTransmissionProtocol.
This one tries to generate requests constantly.
Instead of rewards on successful transmissions, I placed costs on discarding requests.
Minimising discards of requests seems to be the best way to "measure performance" of this model.

The model is regenerative.
...
Requests are generated through Generate regardless of the queue size.
They are discarded if the queue is full, or accepted if it is not.
